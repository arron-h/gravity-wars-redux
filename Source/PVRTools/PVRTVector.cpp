...
// Arron's function
void PVRTMatrixVectorMultiply(PVRTVec3& vDst, const PVRTVec3& vSrc, const PVRTMat3& mxSrc)
	{
	vDst.x = VERTTYPEMUL(vSrc.x,mxSrc.f[0])+VERTTYPEMUL(vSrc.y,mxSrc.f[1])+VERTTYPEMUL(vSrc.z,mxSrc.f[2]);
	vDst.y = VERTTYPEMUL(vSrc.x,mxSrc.f[3])+VERTTYPEMUL(vSrc.y,mxSrc.f[4])+VERTTYPEMUL(vSrc.z,mxSrc.f[5]);
	vDst.z = VERTTYPEMUL(vSrc.x,mxSrc.f[6])+VERTTYPEMUL(vSrc.y,mxSrc.f[7])+VERTTYPEMUL(vSrc.z,mxSrc.f[8]);
	}
